...
public class RulesResource implements IRulesResource {
  ...
  @Override
  public Response createRule(RuleTO ruleTO, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException, UnauthorizedException {
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Override
  public Response updateRule(RuleTO ruleTO, @PathParam("id") long id, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException, UnauthorizedException {
  ...
  @Path("{id}")
  @Override
  public Response deleteRule(@PathParam("id") long id, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException, UnauthorizedException {
