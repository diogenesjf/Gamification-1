...
public class AppUsersResource implements IAppUsersResource {
  ...
  @Override
  public Response createUser(AppUserTO userTO, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException {
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Override
  public Response updateUser(AppUserTO userTO, @PathParam("id") long id, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException, UnauthorizedException {
  ...
  @Path("{id}")
  @Override
  public Response deleteUser(@PathParam("id") long id, @HeaderParam(value = RESTAPI.APP) long idApp) throws EntityNotFoundException, UnauthorizedException {
